                        ...
                        >
                            ...
                            <Box>
                                ...
                                <TextField
                                    ...
                                    onBlur={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (isNaN(val) || val < 0) {
                                            onUpdateSettings('lnMarginTop', 0);
                                        }
                                    }}
                                    type="number"
                                    inputProps={{ min: 0, step: 4 }}
                                    sx={{
                            ...
                            <Box>
                                ...
                                <TextField
                                    size="small"
                                    fullWidth
                                    value={settings.lnMarginBottom ?? 0}
                                    onChange={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (!isNaN(val) && val >= 0) {
                                    ...
                                    onBlur={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (isNaN(val) || val < 0) {
                                            onUpdateSettings('lnMarginBottom', 0);
                                        }
                                    }}
                                    type="number"
                                    inputProps={{ min: 0, step: 4 }}
                            ...
                            <Box>
                                ...
                                <TextField
                                    ...
                                    onBlur={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (isNaN(val) || val < 0) {
                                            onUpdateSettings('lnMarginLeft', 0);
                                        }
                                    }}
                                    type="number"
                                    inputProps={{ min: 0, step: 4 }}
                            ...
                            <Box>
                                ...
                                <TextField
                                    size="small"
                                    fullWidth
                                    value={settings.lnMarginRight ?? 0}
                                    onChange={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (!isNaN(val) && val >= 0) {
                                    ...
                                    onBlur={(e) => {
                                        const val = parseInt(e.target.value, 10);
                                        if (isNaN(val) || val < 0) {
                                            onUpdateSettings('lnMarginRight', 0);
                                        }
                                    }}
                                    type="number"
                                    inputProps={{ min: 0, step: 4 }}
